#tiles
> Making tiled maps with famous.

[![Build Status](https://travis-ci.org/bingomanatee/tiles.svg?branch=master)](https://travis-ci.org/bingomanatee/tiles) [![Dependency Status](https://david-dm.org/bingomanatee/tiles.svg)](https://david-dm.org/bingomanatee/tiles) [![devDependency Status](https://david-dm.org/bingomanatee/tiles/dev-status.svg)](https://david-dm.org/bingomanatee/tiles#info=devDependencies)
...
## Release History
 * 2014-05-10   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)